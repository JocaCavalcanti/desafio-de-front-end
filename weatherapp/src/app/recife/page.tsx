...
export default function Weather() {
  ...
  useEffect(() => {
    const fetchWeatherData = async () => {
      try {
        const forecastResponse = await axios.get<ForecastData>('https://api.openweathermap.org/data/2.5/forecast?q=Recife,br&APPID=faeb1c94d1ffb62f19dd32e8f0e6ebb2');
        const currentWeatherResponse = await axios.get<CurrentWeatherData>('https://api.openweathermap.org/data/2.5/weather?q=Recife,br&APPID=faeb1c94d1ffb62f19dd32e8f0e6ebb2');
