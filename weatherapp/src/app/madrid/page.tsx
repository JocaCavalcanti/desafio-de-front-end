...
export default function Weather() {
  ...
  useEffect(() => {
    ...
    const fetchWeatherData = async () => {
      try {
        const forecastResponse = await axios.get<ForecastData>('https://api.openweathermap.org/data/2.5/forecast?q=Madrid,es&APPID=ded46fd8947879ec29ba6a7963360d88');
        const currentWeatherResponse = await axios.get<any>('https://api.openweathermap.org/data/2.5/weather?q=Madrid,es&APPID=ded46fd8947879ec29ba6a7963360d88');
